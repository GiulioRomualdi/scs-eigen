...
#
# SCSEIGEN_USE_${Package}: Can be disabled by the user if he doesn't want to use that
#                      dependency.
# SCSEIGEN_HAS_${Package}: Internal flag. It should be used to check if a part of
#                      SCSEIGEN should be built. It is on if SCSEIGEN_USE_${Package} is
#                      on and either the package was found or will be built.
# SCSEIGEN_BUILD_${Package}: Internal flag. Used to check if SCSEIGEN has to build an
#                        external package.
# SCSEIGEN_BUILD_DEPS_${Package}: Internal flag. Used to check if dependencies
#                             required to build the package are available.
# SCSEIGEN_HAS_SYSTEM_${Package}: Internal flag. Used to check if the package is
#                             available on the system.
# SCSEIGEN_USE_SYSTEM_${Package}: This flag is shown only for packages in the
...
macro(SCSEIGEN_DEPENDENT_OPTION _option _doc _default _deps _force)
